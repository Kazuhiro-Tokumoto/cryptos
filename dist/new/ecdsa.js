export class PointPairSchnorrP256 {
    ...
    sign(message, privKey, publicKey) {
        ...
        const tBytes = this.sha256(this.concat(this.BigintToBytes(R[0]), this.BigintToBytes(R[1]), this.BigintToBytes(pubKeyBigint[0]), this.BigintToBytes(pubKeyBigint[1]), this.BigintToBytes(e)));
        const t = this.bytesToBigInt(tBytes) % this.N;
        if (t === 0n)
            throw new Error("t==0, retry");
        if (e === 0n)
